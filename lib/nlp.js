// Daftar stopwords untuk tugas pemrosesan bahasa alami
const stopwords = [
...
/**
 * Fungsi untuk membersihkan query pengguna
 * @param {string} query - Query input dari pengguna
 * @returns {string} Query yang telah dibersihkan
 */
 ...
 * @returns {Array} Token yang telah difilter
 */
